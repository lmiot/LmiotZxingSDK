...
package com.lmiot.androidtools_library.zxing.decoding;
...
import com.lmiot.androidtools_library.zxing.MessageIDs;
import com.lmiot.androidtools_library.zxing.view.ViewfinderResultPointCallback;
    ...
    switch (message.what) {
      case MessageIDs.auto_focus:
        ...
        if (state == State.PREVIEW) {
         // LightManager.get().requestAutoFocus(this, MessageIDs.auto_focus);
      ...
      case MessageIDs.decode_failed:
        ...
        state = State.PREVIEW;
        //LightManager.get().requestPreviewFrame(decodeThread.getHandler(), MessageIDs.decode);
